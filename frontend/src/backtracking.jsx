...
function Backtrack() {
  ...
  //   console.log('backtrackSchedule called with subjectIndex:', subjectIndex, 'subjects[subjectIndex]:', subjects[subjectIndex]);
  ...
  //   if (!subject) {
  //     console.error('Undefined subject at index', subjectIndex);
  //     return false; // Itt valami hiba van az adatokban
  //   }
  ...
  //       if (canPlaceSubject(schedule, day, slot, subject)) {
  //         tryPlaceSubject(schedule, day, slot, subject);
  //         if (backtrackSchedule(schedule, subjectIndex + 1)) {
  //           return true;
  //         }
  //         removeSubject(schedule, day, slot);
  //       }
  //     }
  //     // Limit the number of backtracks to avoid excessive computation
